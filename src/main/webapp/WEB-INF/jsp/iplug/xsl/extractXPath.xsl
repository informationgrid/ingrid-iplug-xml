...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ino="http://namespaces.softwareag.com/tamino/response2">
	...
	<xsl:template name="getXpathLink">
		...
		<a href="nameIndexFields.jsp?xpath={$xpath}&amp;connectionIndex={//urlparameters/parameter[@name='connectionIndex']/@value}&amp;mappingIndex={//urlparameters/parameter[@name='mappingIndex']/@value}" style="color:#000000;font-weight:bold">
